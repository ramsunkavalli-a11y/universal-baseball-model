...
BATTING_COLUMN_MAP: dict[str, str] = {
    ...
    "batting_SB": "batting_stolen_bases",
    "batting_CS": "batting_caught_stealing",
    "batting_GiDP_Opp": "batting_gidp_opportunities",
    "batting_GiDP": "batting_ground_into_double_play",
