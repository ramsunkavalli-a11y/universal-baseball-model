...
Status: all simple era candidates rejected; no current range or value changes.

The frozen test forward-scored 226 pitcher careers across the 2017, 2018, and 2019
debut cohorts. Every forecast used only earlier debut cohorts. The incumbent's mean
...
Reject all eight candidates. Changing pitcher usage across eras is real evidence, but
...
The next workload candidate should model the annual MLB pitcher-usage environment
