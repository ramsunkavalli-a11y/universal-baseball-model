...
regressed MLB batting quality conditional on arrival, cumulative batting-component
WAR conditional on arrival, and all-player expected batting-component WAR separately.
The last value retains non-arrivals as zero and exactly equals arrival probability
times conditional cumulative WAR. These values are not total WAR: defense, position
and baserunning are excluded.
