...
Status: performance scale supported; current playable ranges unchanged pending full
mixture confirmation.
...
The scale used for a 2026 forecast, learned through the 2025 origin, is 1.207 for
...
the correct shape, but the full mixture still needs rolling-origin confirmation before
it replaces the playable whole-player ranges.
